...
v = vectorMathLookup.VectorMathLookup()
...
## The basic calculations assume the angle * in the obave diagram is 90 degrees
...
## and these lookups caculate servo settings for the joint angle.
servoLookupCoxa = []
servoLookupFemur = []
servoLookupTibia = []
...
pigs = pigpio.pi() # Connect to local Pi.
...
##    print
    ...
    ##Add in torsion, height here, eventually
